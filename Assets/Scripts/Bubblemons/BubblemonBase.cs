...
public class TypeChart
{
    ...
    public static float GetEffectiveness(BubblemonType attackType, BubblemonType defenseType)
    {
        if (attackType == BubblemonType.None || defenseType == BubblemonType.None)
            return 1;
